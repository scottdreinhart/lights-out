...
export const isUndoCommand = (command: Command): command is UndoCommand => command.type === 'UNDO'

export const isRedoCommand = (command: Command): command is RedoCommand => command.type === 'REDO'
