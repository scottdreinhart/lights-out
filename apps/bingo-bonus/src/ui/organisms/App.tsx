...
/**
 * Bingo Bonus Application - Bonus point system with multiplier scoring
 */
export function App() {
  ...
  const { scoreWin, getLeaderboard, getStats } = useScoring('bonus', gameState)
  ...
  if (phase === 'help')
    return (
      <div className="bingo-help-screen">
        <h2>How to Play Bingo Bonus</h2>
        <p>Earn bonus points for quick wins! Patterns and speed bonuses multiply your score.</p>
  ...
  return (
    <VariantProvider variantId="bonus">
      <div className="bingo-container">
        <div className="bingo-app-header">
          <div className="app-header-content">
            <h1 className="app-title">Bingo Bonus</h1>
