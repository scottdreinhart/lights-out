...
/**
 * Bingo Rush Application - Fast-paced rapid draw mode
 */
export function App() {
  ...
  const { scoreWin, getLeaderboard, getStats } = useScoring('rush', gameState)
  ...
  if (phase === 'help')
    return (
      <div className="bingo-help-screen">
        ...
        <p>Fast-paced bingo action! Mark numbers quickly and achieve patterns for rapid wins.</p>
      ...
      <div className="bingo-container">
        <div className="bingo-app-header">
          <div className="app-header-content">
            <h1 className="app-title">Bingo Rush</h1>
