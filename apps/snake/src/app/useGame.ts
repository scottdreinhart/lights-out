...
import { applyAIMoves } from '@/domain'
import { createInitialGameState, createRunState } from '@/domain'
import { MODE_CONFIGS } from '@/domain'
import { enqueueDirection, gameTick } from '@/domain'
import type {
  AppPhase,
  BoardConfig,
  Difficulty,
