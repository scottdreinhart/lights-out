...
/**
 * Bingo Blackout Application
 * Complete your entire card to win! Full blackout mode with all numbers 1-90.
 */
export function App() {
  ...
  const { scoreWin, getLeaderboard, getStats } = useScoring('blackout', gameState)
  ...
  return (
    <VariantProvider variantId="blackout">
    <div className="bingo-container">
      <div className="bingo-app-header">
        <div className="app-header-content">
          <h1 className="app-title">Bingo Blackout</h1>
