  ...
  if (phase === 'help') {
    return (
      <div className="bingo-help-screen">
        ...
        <p>
          Mark off numbers on your cards as they are called. Complete multiple pattern objectives to
          earn multiplier bonuses! Patterns include lines, corners, frames, plus signs, and full
          house.
        </p>
