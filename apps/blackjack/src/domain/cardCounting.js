 ...
 */
export const createCardCountingState = (deckCount) => ({
    runningCount: 0,
    trueCount: 0,
 ...
 */
export const updateRunningCount = (currentCount, card) => {
    return currentCount + HI_LO_VALUES[card.rank];
};
/**
 * Calculate true count (running count / decks remaining)
 */
export const calculateTrueCount = (runningCount, decksRemaining) => {
    if (decksRemaining <= 0) {
        return 0;
    }
 ...
 */
export const calculateAdvantage = (trueCount) => {
 ...
 */
export const calculateBetMultiplier = (trueCount, minTC = 1) => {
    if (trueCount < minTC) {
        return 1;
 ...
 */
export const updateCountingState = (state, card, cardsDealt, totalCardsInShoe) => {
 ...
 */
export const resetCountingState = (deckCount) => {
 ...
 */
export const getCountValueDisplay = (card) => {
 ...
 */
export const getCountingStrategyAdvice = (trueCount) => {
    if (trueCount >= 2) {
 ...
 */
export const getCountingDifficulty = (trueCount, accuracy) => {
 ...
 */
export const calculatePenetration = (cardsDealt, totalCards) => {
 ...
 */
export const shouldReshuffleShoe = (penetration) => {
 ...
 */
export const evaluateCountingAccuracy = (playerCount, trueCount) => {
 ...
 */
export const getHiLoExplanation = () => {
    return `
Hi-Lo Card Counting:
 ...
 */
export const getBetSizingStrategy = (trueCount, minBet, maxBet) => {
