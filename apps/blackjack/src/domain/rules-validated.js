 ...
 *   }
 */
export function validateAndProcessAction(gameState, action) {
 ...
 */
export function validateAndPlaceBet(gameState, betAmount) {
    // Validate bet amount
 ...
 */
export function getSanitizedPlayerName(playerName) {
 ...
 */
export function getSanitizedGameState(gameState) {
    const player = gameState.players[0];
    if (!player) {
        return gameState;
    }
