...
import type { GameAction, GameState, Hand } from './types'

export interface BlackjackSignalProfile {
  pressure: number
  intensity: number
  focus: number
  progress: number
...
export function buildBlackjackSignalProfile(
  gameState: GameState,
  currentHand: Hand | null,
  availableActions: readonly GameAction[],
): BlackjackSignalProfile {
