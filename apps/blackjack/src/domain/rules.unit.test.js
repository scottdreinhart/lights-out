...
import { calculateHandValue, canDoubleDown, canHit, canSplit, canStand, determineOutcome, getBestHandValue, isBust, isNaturalBlackjack, } from './rules';
const createCard = (suit, rank) => ({
    id: `${suit}-${rank}`,
    suit: suit,
    rank: rank,
});
const createHand = (cards, bet = 10) => ({
...
describe('Blackjack Domain Rules', () => {
    ...
    describe('determineOutcome', () => {
        it('should return loss for bust hand', () => {
        ...
        it('should return win for natural blackjack against lower dealer hand', () => {
