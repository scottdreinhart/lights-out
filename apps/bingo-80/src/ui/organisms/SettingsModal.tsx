/**
 * Settings Modal Adapter for Bingo-80 App
 * Wraps the shared SettingsModal component with bingo-80-specific configuration.
 */

import { SettingsModal as SharedSettingsModal } from '@games/bingo-ui-components'
 ...
 * Includes theme/palette selection for the 80-ball Bingo game.
 */
