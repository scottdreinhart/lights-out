  ...
  if (phase === 'help') {
    return (
      <div className="bingo-help-screen">
        <h2>How to Play Bingo Survival</h2>
        <p>
          Survive the time limit! Mark patterns before time runs out. The longer you last, the
          harder it gets!
        </p>
      ...
      <div className="bingo-container">
        <div className="bingo-app-header">
          <div className="app-header-content">
            <h1 className="app-title">Bingo Survival</h1>
