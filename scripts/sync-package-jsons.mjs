...
const standardTemplate = {
  ...
  scripts: {
    ...
    prebuild: 'pnpm clean',
    'electron:dev':
      'pnpm exec concurrently -k "pnpm exec vite" "pnpm exec wait-on http://localhost:5173 && pnpm exec electron ."',
    ...
    'report:all':
      'pnpm report:lint && pnpm report:typecheck && pnpm report:test && pnpm report:coverage && pnpm report:a11y && pnpm report:lighthouse && pnpm report:security && pnpm report:build',
...
function syncPackageJson(appPath) {
  ...
  packageJson.devDependencies = {
    ...standardTemplate.devDependencies,
    ...packageJson.devDependencies,
  }
