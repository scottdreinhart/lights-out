...
- **Bash / POSIX Shell** (WSL on Windows, native on macOS/Linux) — See [Shell Routing Governance](#shell-routing-governance) below

### Shell Routing Governance

**Bash (POSIX) is the mandatory default shell for all development in this repository.**
...
**All commands below use Bash (WSL on Windows, native on macOS/Linux).**
...
**All commands below use Bash (WSL on Windows, native on macOS/Linux).** This is the mandatory default shell. See [Shell Routing Governance](#shell-routing-governance) above for complete information.
