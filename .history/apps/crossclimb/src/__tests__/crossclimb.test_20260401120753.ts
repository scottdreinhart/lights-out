...
import { createRandomGraph, createInitialState, isValidMove, makeMove, isValidPath, calculatePathWeight } from '../domain'
...
describe('Crossclimb Game Logic', () => {
  ...
  describe('Move Validation', () => {
    ...
    it('should reject moves to non-adjacent nodes', () => {
      ...
      const nonAdjacentNodeId = allNodeIds.find(nodeId => {
        ...
        const isAdjacent = Object.values(graph.edges).some(edge =>
  ...
  describe('Path Validation', () => {
    it('should validate complete paths from start to end', () => {
      ...
      const hasDirectEdge = Object.values(graph.edges).some(edge =>
