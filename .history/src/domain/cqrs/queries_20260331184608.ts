...
export const isCanUndoQuery = (query: Query): query is CanUndoQuery => query.type === 'CAN_UNDO'

export const isCanRedoQuery = (query: Query): query is CanRedoQuery => query.type === 'CAN_REDO'
