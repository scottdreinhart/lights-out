  ...
  try {
    switch (msg.type) {
      ...
      default:
        ...
        handleError(`Unknown request type: ${(msg as WorkerRequest).type}`, msg.requestId)
    }
  } catch (error) {
    handleError(
 ...
 */
function handleSolveRequest(msg: WorkerSolveRequest) {
 ...
 */
function handleGenerateRequest(msg: WorkerGenerateRequest) {
 ...
 */
function handlePropagateRequest(msg: WorkerPropagateRequest) {
