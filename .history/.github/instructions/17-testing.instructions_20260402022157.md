...
**All test commands use Bash (WSL on Windows, native on macOS/Linux).** This is the mandatory default shell. Never use PowerShell for testing. See [AGENTS.md § 5](../../AGENTS.md#5-cross-platform-shell-governance-mandatory) (Cross-platform Shell Governance) for complete shell rules.
