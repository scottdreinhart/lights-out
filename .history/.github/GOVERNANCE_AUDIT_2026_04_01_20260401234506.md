...
| PHASE_*.md | Root | Phase completion reports | 📦 ARCHIVED | No — preserves history |
| DOCUMENTATION_INDEX.md | Root | Old index (use docs/README.md) | 📦 ARCHIVED | No — cross-reference instead |
| docs/SPRINT_*.md | docs/ | Sprint planning docs | 📦 ARCHIVED | No — preserve for reference |
| docs/PHASE_*.md | docs/ | Phase reports | 📦 ARCHIVED | No — preserve for context |
