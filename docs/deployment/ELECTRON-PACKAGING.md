...
apps/lights-out/vite.config.ts  # Build config (with Electron plugin support)
...
└─────────────────┬───────────────────────┘
                  │
        IPC Bridge (apps/lights-out/electron/preload.js)
                  │
┌─────────────────▼───────────────────────┐
...
## Preload Script (apps/lights-out/electron/preload.js)
...
**apps/lights-out/electron/preload.js** (40 lines):
...
```javascript
// In apps/lights-out/electron/main.js (dev mode):
...
**Fix:**
```javascript
// Verify in apps/lights-out/electron/main.js:
