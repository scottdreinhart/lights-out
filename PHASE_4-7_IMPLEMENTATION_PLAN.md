...
**Tier 2 (Medium Reuse, Medium Complexity)**:
5. `@games/ui-form-group` — Label + Input composite
6. `@games/ui-modal` — Modal dialog frame
7. `@games/ui-tabs` — Tab navigation bar
...
**Tier 2 (Medium Reuse)**:
3. `@games/puzzle-constraints` — Sudoku-variant constraint system
